...
<!--*********************************************START OF NAVIGATION BAR****************************************--> 
        ...
        ?>
                    ...
                    <td  style="border: 1px dashed #8c8b8b;"><center><strong class="wow fadeInDown"><p style="margin-top:25px;"><?php echo $count;?></p></strong></center></td>
...
<div class="modal fade" id="orderModal<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
 ...
 else {echo '<strong style="color:red">No available data in server</strong>'; } 
...
if(isset($_POST['savechanges'])){
    ...
    $result=mysqli_query($con, $sql);
			if(mysqli_num_rows($result)==5){
					echo '<script>alert("You reached maximum order of 5");
        ...
        $result=mysqli_query($con, $sql);
							if($result==true){
								echo '<script>alert("Your order will be processed. The system will follow up by contacting your number. Thank you!");
