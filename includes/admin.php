...
<head>
    ...
    <title>ADMIN|ThePawsitivePetCare Online Website</title>
            ...
            <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                     ...
                     <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;"><i class="fa fa-coffee"></i> Ordering Of Pet</h4></a>
                </div>
    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="fdid" value="<?php echo $row['id']?>">
        ...
        <dl class="dl-horizontal wow fadeInDown" style="text-align:left">
            ...
            <dt>Price:</dt> <dd><?php echo 'Rs. '.$row['prize'];?></dd>
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2023 <a target="_blank" href="#" title="#"> ThePawsitivePetCare Online Website</a>. All Rights Reserved.</center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
